...
{
    /// <summary>
    /// 提供一组对 双精度（64 位）浮点数字(System.Double) 操作方法的扩展。
    /// </summary>
    public static class DoubleExtensions
    {
        ...
        public static bool IsOdd(this Double _this)
        {
            return (_this % 2) == 1;
        }
        ...
        public static bool IsEven(this Double _this)
        {
            return (_this % 2) == 0;
        }
        ...
        public static Double Round(this Double _this, int digits)
        {
        ...
        public static int GetDigits(this Double _this)
        {
