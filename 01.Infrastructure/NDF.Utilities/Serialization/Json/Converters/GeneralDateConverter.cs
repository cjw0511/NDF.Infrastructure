...
namespace NDF.Serialization.Json.Converters
{
    ...
    ///     如果日期时间对象既存在日期部分又存在时间部分，则按照 <see cref="DateTimeConverter"/> 默认格式 "yyyy/MM/dd hh:mm:ss.fff" 显示。
    /// </summary>
    public class GeneralDateConverter : DateTimeConverter
    {
        /// <summary>
        /// 初始化类型 <see cref="GeneralDateConverter"/> 的新实例。
        /// </summary>
        public GeneralDateConverter() { }
