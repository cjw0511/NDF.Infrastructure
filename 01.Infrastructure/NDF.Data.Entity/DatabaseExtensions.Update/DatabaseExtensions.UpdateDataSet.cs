...
namespace NDF.Data.Entity
{
    public static partial class DatabaseExtensions
    {
        ...
        {
            return GetGeneralDatabase(database).UpdateDataSet(dataSet, tableName, insertCommand, updateCommand, deleteCommand);
        }
        ...
        /// <returns>表示脚本命令执行受影响的行数。</returns>
        public static int UpdateDataSet(this Database database, DataSet dataSet, string tableName, DbCommand insertCommand, DbCommand updateCommand, DbCommand deleteCommand, Microsoft.Practices.EnterpriseLibrary.Data.UpdateBehavior updateBehavior)
        {
            return GetGeneralDatabase(database).UpdateDataSet(dataSet, tableName, insertCommand, updateCommand, deleteCommand, updateBehavior);
        }
        ...
        {
            return GetGeneralDatabase(database).UpdateDataSet(dataSet, tableName, insertCommand, updateCommand, deleteCommand, updateBatchSize);
        }
        ...
        {
            return GetGeneralDatabase(database).UpdateDataSet(dataSet, tableName, transaction, insertCommand, updateCommand, deleteCommand);
        }
        ...
        {
            return GetGeneralDatabase(database).UpdateDataSet(dataSet, tableName, transaction, insertCommand, updateCommand, deleteCommand, updateBatchSize);
        }
