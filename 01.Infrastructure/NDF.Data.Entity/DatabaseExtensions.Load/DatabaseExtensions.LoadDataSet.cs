...
namespace NDF.Data.Entity
{
    public static partial class DatabaseExtensions
    {
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, command);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, commandText);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, commandText, parameterValues);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, commandText, commandType);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, commandText, commandType, parameterValues);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, tableNames, command);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, tableNames, commandText);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, tableNames, commandText, parameterValues);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, tableNames, commandText, commandType);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, tableNames, commandText, commandType, parameterValues);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, command);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, commandText);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, commandText, parameterValues);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, commandText, commandType);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, commandText, commandType, parameterValues);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, tableNames, command);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, tableNames, commandText);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, tableNames, commandText, parameterValues);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, tableNames, commandText, commandType);
        }
        ...
        {
            GetGeneralDatabase(database).LoadDataSet(dataSet, transaction, tableNames, commandText, commandType, parameterValues);
        }
