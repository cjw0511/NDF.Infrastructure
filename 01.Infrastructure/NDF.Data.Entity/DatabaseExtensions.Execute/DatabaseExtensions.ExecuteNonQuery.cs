...
namespace NDF.Data.Entity
{
    public static partial class DatabaseExtensions
    {
        ...
        public static int ExecuteNonQuery(this Database database, DbCommand command)
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(command);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(commandText);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(commandText, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(commandText, commandType);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(commandText, commandType, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行受影响的行数。</returns>
        public static int ExecuteNonQuery(this Database database, string commandText, CommandType commandType, params object[] parameterValues)
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(commandText, commandType, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(transaction, command);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(transaction, commandText);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(transaction, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行受影响的行数。</returns>
        public static int ExecuteNonQuery(this Database database, DbTransaction transaction, string commandText, params object[] parameterValues)
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(transaction, commandText, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(transaction, commandText, commandType);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteNonQuery(transaction, commandText, commandType, parameterValues);
        }
