...
namespace NDF.Data.EntityFramework
{
    public static partial class DatabaseExtensions
    {
        ...
        public static DataSet ExecuteDataSet(this Database database, DbCommand command)
        {
            return GetGeneralDatabase(database).ExecuteDataSet(command);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(commandText);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataSet"/> 对象。</returns>
        public static DataSet ExecuteDataSet(this Database database, string commandText, params object[] parameterValues)
        {
            return GetGeneralDatabase(database).ExecuteDataSet(commandText, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(commandText, commandType);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(commandText, commandType, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(transaction, command);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(transaction, commandText);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(transaction, commandText, parameterValues);
        }
        ...
        /// <param name="parameterValues">表示用于执行 <paramref name="commandText"/> 命令的参数列表。</param>
        /// <returns>表示脚本命令执行的结果的一个 <see cref="DataSet"/> 对象。</returns>
        public static DataSet ExecuteDataSet(this Database database, DbTransaction transaction, string commandText, params object[] parameterValues)
        {
            return GetGeneralDatabase(database).ExecuteDataSet(transaction, commandText, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(transaction, commandText, commandType);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataSet(transaction, commandText, commandType, parameterValues);
        }
