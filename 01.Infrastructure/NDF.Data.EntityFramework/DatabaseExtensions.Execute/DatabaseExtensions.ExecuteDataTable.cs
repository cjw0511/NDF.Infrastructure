...
namespace NDF.Data.EntityFramework
{
    public static partial class DatabaseExtensions
    {
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(command);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(commandText);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(commandText, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(commandText, commandType);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(commandText, commandType, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(transaction, command);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(transaction, commandText);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(transaction, commandText, parameterValues);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(transaction, commandText, commandType);
        }
        ...
        {
            return GetGeneralDatabase(database).ExecuteDataTable(transaction, commandText, commandType, parameterValues);
        }
