...
二、功能概述：
    ...
    6、支持多台 Slave 节点之间的负载均衡：
        如果设定了多台 Slave 服务器节点，在每次执行查询操作时，支持按照设定顺序选择第一台可用的 Slave 服务器，也支持随机选择所有可用的 Slave 服务器中
