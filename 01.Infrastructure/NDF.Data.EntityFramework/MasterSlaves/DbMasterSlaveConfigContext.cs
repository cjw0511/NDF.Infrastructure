...
namespace NDF.Data.EntityFramework.MasterSlaves
{
    ...
    public class DbMasterSlaveConfigContext : Disposable
    {
        ...
        private bool _serverStateScanWithNoOffline;
        ...
        internal DbMasterSlaveConfigContext(ApplyItemSection applyItem)
            : this()
        {
        ...
        {
            get { return this._serverStateScanInterval; }
        }
        ...
        {
            get { return this._serverStateScanWithNoOffline; }
        }
        ...
        private void InitializeProperties()
        {
            ...
            this._serverStateScanWithNoOffline = this.ApplyItemSection.ServerStateScanWithNoOffline;
        ...
        private void InitializeMasterServer(MasterConnectionStringElement master)
        {
            ...
            this._master = new DbMasterServer(master.ConnectionString);
        }
