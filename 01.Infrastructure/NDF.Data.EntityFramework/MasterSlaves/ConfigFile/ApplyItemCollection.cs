...
{
    /// <summary>
    /// 表示一个包含 <see cref="ApplyItemSection"/> 集合的配置元素。
    /// </summary>
    public class ApplyItemCollection : ConfigurationElementCollection
    {
        ...
        /// <summary>
        /// 获取或设置位于集合中指定索引处的 <see cref="ApplyItemSection"/> 对象。
        /// </summary>
        /// <param name="index">集合中 <see cref="ApplyItemSection"/> 对象的索引。</param>
        /// <returns></returns>
        public ApplyItemSection this[int index]
        {
            get { return (ApplyItemSection)BaseGet(index); }
            set
            {
        ...
        /// <summary>
        /// 根据 EF 数据库上下文类型获取其所对应的 <see cref="ApplyItemSection"/> 对象。
        /// <para>如果没找到 <paramref name="targetContextType"/> 对应的 <see cref="ApplyItemSection"/> 对象，该索引器属性将返回 null。</para>
        /// </summary>
        /// <param name="targetContextType"></param>
        /// <returns></returns>
        public ApplyItemSection this[Type targetContextType]
        {
            get
            {
                ...
                {
                    var section = c as ApplyItemSection;
                    if (section == null)
                        continue;
        ...
        /// <summary>
        /// 根据 EF 数据库上下文对象获取其所对应的 <see cref="ApplyItemSection"/> 对象。
        /// <para>如果没找到 <paramref name="context"/> 对应的 <see cref="ApplyItemSection"/> 对象，该索引器属性将返回 null。</para>
        /// </summary>
        ...
        /// <param name="targetContextType"></param>
        /// <returns></returns>
        public ApplyItemSection GetApplyItem(Type targetContextType)
        {
        ...
        private bool ValidateApplyItemSection(ConfigurationElement element)
        {
            ...
            ApplyItemSection applyItem = (ApplyItemSection)BaseGet(key);
            if (applyItem != null && applyItem.TargetContextFullName != ((ApplyItemSection)element).TargetContextFullName)
            {
        ...
        /// <summary>
        /// 创建一个新的 <see cref="ApplyItemSection"/>。
        /// </summary>
        /// <returns></returns>
        protected override ConfigurationElement CreateNewElement()
        {
            return new ApplyItemSection();
        }
        ...
        {
            return ((ApplyItemSection)element).TargetContextFullName;
        }
